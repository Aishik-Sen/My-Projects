...
static long eval_const_expr(Token **rest, Token *tok) {
  ...
  //  The standard requires we replace remaining non-macro identifiers with "0" before
...
// __DATE__ is expanded to the current date.
...
// __TIME__ is expanded to the current time.
