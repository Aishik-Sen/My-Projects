...
int main(){
    ...
    ASSERT(55,({int i=0;int j=0;for(i=0;i<=10;i+=1)j=i+j;j;}));

    ASSERT(10, ({ int i=0; while(i<10) i=i+1; i; }));
    ASSERT(3,({1;{2;}3;}));
    ASSERT(5,({;;;5;}));
    ASSERT(10,({int i=0;while(i<10)i+=1;i;}));
    ASSERT(55,({int i=0;int j=0;while(i<=10){j=i+j;i+=1;}j;}));
