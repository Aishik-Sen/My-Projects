//implementation of the open addressing hashtable

#include "tinycc.h"
 #define INIT_SIZE 16
 #define HIGH_WATERMARK 70
 //rehash if usage is above this percentage
 #define LOW_WATERMARK 20
 //rehash if usage is below this percentage
 ...
 //make room for the new entries in given hashmap by removing tombstones and extending bucket sizes
